export const propertiesData = {
  ...
  3: {
    ...
    description:
      "Résidence d'exception nichée dans le cadre verdoyant d'Akanda. Cette villa d'architecte de 420 m² allie volumes généreux et finitions luxueuses : double salon, salle à manger de réception, cuisine professionnelle, 6 suites avec salles de bain privatives, et un espace piscine avec pool-house. Un bien rare sur le marché gabonais.",
    amenities: [

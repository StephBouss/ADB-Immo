export const propertiesData = {
  ...
  2: {
    ...
    image2: "/images/appartement-luxe-2.jpg.png",
    image3: "/images/appartement-luxe-3.jpg.png",
    description:
      "Superbe appartement de standing dans une résidence contemporaine de Batterie IV, à deux pas du front de mer. La façade architecturale en pierre ardoise, béton blanc et bardage terracotta confère à l'ensemble un cachet unique. L'intérieur propose une cuisine américaine haut de gamme avec îlot central en marbre, équipements encastrés dernier cri et éclairage LED d'ambiance. Trois chambres lumineuses, deux salles de bain, et terrasses privatives avec vue dégagée.",
    amenities: [
      "Façade architecturale premium",
      "Cuisine américaine en marbre",
      "Îlot central équipé",
      "Éclairage LED d'ambiance",
      "Terrasses privatives",
      "Climatisation",
      "Parking privatif",
      "Résidence sécurisée 24h",
    ],
  },
  3: {
    id: 3,
